...
function useMapInstance(props, context) {
  ...
  const {
    ...
    renderingType,
    colorScheme
  } = props, mapOptions = _objectWithoutPropertiesLoose(props, _excluded$3);
...
var MarkerContent = ({
  ...
  } = _ref, restStyles = _objectWithoutPropertiesLoose(_ref, _excluded$2);
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (anchor) {
      ...
      if (isAdvancedMarker(anchor) && anchor.content instanceof Element) {
        ...
        const wrapperBcr = (_anchor$content$getBo = anchor.content.getBoundingClientRect()) != null ? _anchor$content$getBo : {};
        const {
          width: anchorWidth,
          height: anchorHeight
        } = wrapperBcr;
        if (anchorWidth === 0 && anchorHeight === 0) {
          ...
          const anchorOffsetX = contentBcr.x - wrapperBcr.x + contentBcr.width / 2;
...
var Pin = (props) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const markerContent = (_advancedMarker$conte = advancedMarker.content) == null ? void 0 : _advancedMarker$conte.firstChild;
